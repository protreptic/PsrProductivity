...
public class RegTprDiscountEntityView extends
		GenericEntityView<RegTprDiscount,RegTprDiscountEntity> implements
		OnItemClickListener {
  
	public RegTprDiscountEntityView(
			RegTprDiscountEntity entity,
			Float price) {
		super(MainActivity.getInstance(), new RegTprDiscount(MainActivity.getInstance()), entity);
