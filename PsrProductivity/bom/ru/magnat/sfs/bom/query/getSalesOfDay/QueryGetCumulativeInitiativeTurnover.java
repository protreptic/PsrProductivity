...
public final class QueryGetCumulativeInitiativeTurnover extends
		QueryGeneric<QueryGetCumulativeInitiativeTurnoverEntity> {
	...
	public QueryGetCumulativeInitiativeTurnover(Context context, Date date,
			int horizon, RefKpiEntity kpi) {
		super(context, QueryGetCumulativeInitiativeTurnoverEntity.class, query);
