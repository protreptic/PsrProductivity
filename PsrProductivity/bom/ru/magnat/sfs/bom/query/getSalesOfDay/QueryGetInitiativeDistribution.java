...
public final class QueryGetInitiativeDistribution extends
		QueryGeneric<QueryGetInitiativeDistributionEntity> {
	...
	public QueryGetInitiativeDistribution(Context context, Date date,
			int horizon, RefKpiEntity kpi, RefInitiativeEntity initiative) {
		super(context, QueryGetInitiativeDistributionEntity.class, query);
