...
public class UlFileTransferUpload extends AsyncTask<String, String, String> implements FileTransferProgressListener {
	SyncMaster _master;
	String _result = "";
	int _state = -1;
	...
	final long _sendedSize;
	FileTransferProgressData _progressData;
	final boolean _keepProgressDialog;
	//final boolean _deleteOnSuccess;
	protected ProgressDialog _progressDialog=null;
	public UlFileTransferUpload(Context context, String fileName,
			String filePath, String username, String passkey
			, long totalSize
			, long sendedSize
		...
		_fileName = fileName;
		_filePath = filePath;
		//_deleteOnSuccess = deleteOnSuccess;
		_keepProgressDialog = !(progressDialog==null);
		_progressDialog = progressDialog;
		_totalSize = totalSize;
		_sendedSize = sendedSize;
	...
	public String getFilePath() {
		return _filePath + ((_filePath.endsWith("/"))?"":"/");
	}
	...
	protected void onProgressUpdate(String... values) {
		...
		String message = "Отправка файла\n" + _fileName + "\nОтправлено "
				...
				;
		if (_keepProgressDialog) {
			_progressDialog.setProgress((int)((_sendedSize+transferred)/1024));
