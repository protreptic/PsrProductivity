...
public class DocRequestOnChangeContractorListViewItem
		extends
		GenericListItemView<DocRequestOnChangeContractorJournal, DocRequestOnChangeContractorEntity> {

	final DocRequestOnChangeContractorEntity _doc;
	TextView _order_text;

	public DocRequestOnChangeContractorListViewItem(Context context,
			DocRequestOnChangeContractorJournal list, ListView lv,
			DocRequestOnChangeContractorEntity doc) {
