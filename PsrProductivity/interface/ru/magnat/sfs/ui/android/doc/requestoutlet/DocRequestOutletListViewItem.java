...
public class DocRequestOutletListViewItem
		extends
		GenericListItemView<DocRequestOutletJournal, DocRequestOutletEntity> {

	final DocRequestOutletEntity _doc;
	TextView _order_text;

	public DocRequestOutletListViewItem(Context context,
			DocRequestOutletJournal list, ListView lv,
			DocRequestOutletEntity doc) {
