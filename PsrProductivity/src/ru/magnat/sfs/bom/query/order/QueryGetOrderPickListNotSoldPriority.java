...
public final class QueryGetOrderPickListNotSoldPriority extends
	...
	public QueryGetOrderPickListNotSoldPriority(Context context,
			DocOrderEntity entity, PickFilter filter) {

		super(context, entity, filter, _query);
		//this.mOutOfStockFilterIsActive = SFSActivity.Me.PropertyFilterListB_itemsChecked[0];
	}
	...
	public Boolean setSelectParameters(ArrayList<SqlCriteria> criteria) {
		...
		try {
			...
			if (_doc.TradeRule == null)
				_select_statement.setNull(++param); //BUGFIX #251,252 ANALOGUE USMANOV
