...
import ru.magnat.sfs.ui.android.doc.marketingmeasure.QueryMarketingMeasureListView;
import ru.magnat.sfs.ui.android.doc.order.DocOrderEntityView;
import android.content.Context;
import android.widget.ListView;

public final class QueryGetMarketingMeasures extends QueryGeneric<QueryGetMarketingMeasuresEntity> {
	...
	public QueryGetMarketingMeasures(Context context, final Long outletId, final DateTime createDate) {
		super(context, QueryGetMarketingMeasuresEntity.class, query);
		mOutletId = outletId;
	...
	public SfsContentView GetExtendedListItemView(ListView lv) {
		return new QueryMarketingMeasureListView.QueryMarketingMeasureViewItem(_context, this, lv, Current());
	}
