...
public final class QueryGetGoldenDistributionByOutlet extends
		QueryGeneric<QueryGetDistributionByOutletEntity> {

	final RefOutletEntity _outlet;
	final RefEmployeeEntity _employee;
	static final String query = "select Max(Outlet) as Id, count(distinct Csku) as Distribution from regsales where ABC = 1";

	public QueryGetGoldenDistributionByOutlet(Context context,
